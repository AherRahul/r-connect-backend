...
import { socketIOImageObject } from '../../../shared/scokets/image';
...
export class Add {
  ...
  public async profileImage(req: Request, res: Response): Promise<void> {
    ...
    const url = `https://res.cloudinary.com/duojkrgue/image/upload/v${result.version}/r-connect/${result.public_id}`;
