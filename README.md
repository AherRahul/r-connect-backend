...
```bash
git clone -b develop https://github.com/aherrahul/r-connect-backend.git
npm install
```
...
## API Endpoints
- The actual endpoints for the application can be found inside the folder named `endpoints` [https://github.com/aherrahul/r-connect-backend/tree/develop/endpoints](https://github.com/aherrahul/r-connect-backend/tree/develop/endpoints). 
...
## You can find the frontend code [here](https://github.com/aherrahul/r-connect-frontend)
